...
\definecolor{typescriptBackgroundColor}{RGB}{240, 240, 240}

\lstdefinelanguage{TypeScript}{
	keywords={abstract, as, boolean, break, case, catch, class, console, 
		const, continue, debugger, declare, default, delete, do, enum, export, 
		extends, false, finally, for, from, function, get, implements, import, in, 
		...
		set, static, super, switch, symbol, this, true, try, type, typeof, 
		undefined, unique, unknown, var, void, while, with, yield},
	morekeywords=[2]{if, else, return, throw},
	morekeywords=[3]{any, string},
	morecomment=[l]{//},
	morecomment=[s]{/*}{*/},
	morestring=[b]',
	morestring=[b]",
	...
	backgroundcolor=\color{typescriptBackgroundColor},
	showstringspaces=false,
}

\lstnewenvironment{typescript}[1][]
{\lstset{language=TypeScript, #1}}
{}
...
\newcommand{\citationNeeded}{\textbf{[Cita requerida]}}

\NewDocumentCommand{\todo}{o}{\textbf{[Por hacer\IfValueT{#1}{: #1}]}}
