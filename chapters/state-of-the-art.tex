...
\begin{enumerate}
	...
	\item El modelo monitor invita a pensar que la capacidad comunicadora en una lengua mejora naturalmente con la adquisición del idioma. No obstante, esta idea tiene algunos críticos, sobre todo el lingüista Merrill Swain, que desarrolló la \textit{hipótesis de salida}. Practicar la salida podría, además, ayudar a los profesores a conocer mejor el nivel de los alumnos, y de esta forma guiarlos mejor. \autocite{Output}
\end{enumerate}
