...
\begin{figure}[H]
	...
	\caption[Vista de lectura]{Vista de lectura. \todo[Actualizar imagen].}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[width=1\textwidth]{view-texts.png}
	\caption[Vista de textos]{Vista de textos. \todo[Actualizar imagen].}
\end{figure}

En esta página, el usuario puede acceder a los distintos textos guardados, ordenados por carpetas. \todo[Leyes Gestalt y otros conceptos aplicados en el listado]
